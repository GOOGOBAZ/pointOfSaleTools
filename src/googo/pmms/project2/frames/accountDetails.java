 ...
 */
public class accountDetails extends javax.swing.JFrame implements MouseListener, IUpdateText, ActionListener,KeyListener{
String userId,itemIndicator;
 BioDataMetaData wasNot;
...
// AccountNumberCreationDataBase db =new AccountNumberCreationDataBase();
    ...
    public accountDetails(String userId,BioDataMetaData thisOne) {
...
jTable1.setGridColor(Color.gray);
    ...
    private void initComponents() {
        ...
        jButton2.setBounds(160, 460, 140, 40);
        ...
        jButton3.setBounds(310, 460, 140, 40);
        ...
        jScrollPane1.setBounds(20, 20, 960, 420);

        jLabel1.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel1.setText("SEARCH HERE");
        jLabel1.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        jPanel2.add(jLabel1);
        jLabel1.setBounds(610, 460, 140, 40);

        jTextField1.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jPanel2.add(jTextField1);
        jTextField1.setBounds(750, 460, 230, 40);

        jPanel1.add(jPanel2);
        jPanel2.setBounds(10, 10, 990, 520);
        ...
        jButton73.setBackground(new java.awt.Color(201, 222, 223));
        jButton73.setText("Blue");
        getContentPane().add(jButton73);
        jButton73.setBounds(1870, 170, 53, 23);

        jButton74.setBackground(java.awt.SystemColor.activeCaption);
        jButton74.setText("Blue");
        getContentPane().add(jButton74);
        jButton74.setBounds(1810, 190, 53, 23);

        jButton75.setBackground(java.awt.SystemColor.activeCaption);
        jButton75.setText("Blue");
        getContentPane().add(jButton75);
        jButton75.setBounds(1870, 190, 53, 23);

        jButton76.setBackground(java.awt.SystemColor.activeCaption);
        jButton76.setText("Blue");
        getContentPane().add(jButton76);
        jButton76.setBounds(1920, 190, 53, 23);

        jButton77.setBackground(java.awt.SystemColor.activeCaption);
        jButton77.setText("Blue");
        getContentPane().add(jButton77);
        jButton77.setBounds(1810, 210, 53, 23);

        jButton78.setBackground(new java.awt.Color(204, 165, 165));
        jButton78.setText("Blue");
        getContentPane().add(jButton78);
        jButton78.setBounds(1870, 210, 53, 23);

        jButton79.setBackground(new java.awt.Color(204, 204, 255));
        jButton79.setText("Blue");
        getContentPane().add(jButton79);
        jButton79.setBounds(1920, 210, 53, 23);

        jButton80.setBackground(new java.awt.Color(0, 153, 255));
        jButton80.setText("Blue");
        getContentPane().add(jButton80);
        jButton80.setBounds(1810, 230, 53, 23);

        jButton81.setBackground(new java.awt.Color(204, 204, 204));
        jButton81.setText("Blue");
        getContentPane().add(jButton81);
        jButton81.setBounds(1870, 230, 53, 23);

        jButton82.setBackground(new java.awt.Color(0, 204, 102));
        jButton82.setText("Blue");
        getContentPane().add(jButton82);
        jButton82.setBounds(1920, 230, 53, 23);

        jButton83.setBackground(new java.awt.Color(255, 204, 204));
        jButton83.setText("Blue");
        getContentPane().add(jButton83);
        jButton83.setBounds(1810, 250, 53, 23);

        jButton84.setBackground(new java.awt.Color(255, 255, 204));
        jButton84.setText("Blue");
        getContentPane().add(jButton84);
        jButton84.setBounds(1870, 250, 53, 23);

        jButton85.setBackground(new java.awt.Color(0, 204, 255));
        jButton85.setText("Blue");
        getContentPane().add(jButton85);
        jButton85.setBounds(1920, 250, 53, 23);

        jButton86.setBackground(new java.awt.Color(152, 198, 94));
        jButton86.setText("Blue");
        getContentPane().add(jButton86);
        jButton86.setBounds(1810, 270, 53, 23);

        jButton87.setBackground(new java.awt.Color(204, 153, 255));
        jButton87.setText("Blue");
        getContentPane().add(jButton87);
        jButton87.setBounds(1870, 270, 53, 23);

        jButton88.setBackground(new java.awt.Color(0, 204, 204));
        jButton88.setText("Blue");
        getContentPane().add(jButton88);
        jButton88.setBounds(1920, 270, 53, 23);

        jButton89.setBackground(new java.awt.Color(204, 204, 0));
        jButton89.setText("Blue");
        getContentPane().add(jButton89);
        jButton89.setBounds(1810, 290, 53, 23);

        jButton90.setBackground(new java.awt.Color(0, 153, 153));
        jButton90.setText("Blue");
        getContentPane().add(jButton90);
        jButton90.setBounds(1870, 290, 53, 23);

        jButton91.setBackground(new java.awt.Color(204, 255, 204));
        jButton91.setText("Blue");
        getContentPane().add(jButton91);
        jButton91.setBounds(1930, 290, 53, 23);

        jButton92.setBackground(new java.awt.Color(255, 204, 153));
        jButton92.setText("Blue");
        getContentPane().add(jButton92);
        jButton92.setBounds(1810, 310, 53, 23);

        jButton93.setBackground(new java.awt.Color(255, 204, 204));
        jButton93.setText("jButton5");
        getContentPane().add(jButton93);
        jButton93.setBounds(1870, 320, 73, 23);

        jButton94.setBackground(java.awt.SystemColor.controlLtHighlight);
        jButton94.setText("jButton5");
        getContentPane().add(jButton94);
        jButton94.setBounds(1790, 330, 73, 23);

        jButton95.setBackground(new java.awt.Color(0, 51, 51));
        jButton95.setText("jButton5");
        getContentPane().add(jButton95);
        jButton95.setBounds(1800, 360, 73, 23);

        jButton96.setBackground(java.awt.SystemColor.controlLtHighlight);
        jButton96.setText("jButton5");
        getContentPane().add(jButton96);
        jButton96.setBounds(1800, 410, 73, 23);

        jButton97.setBackground(new java.awt.Color(255, 204, 204));
        jButton97.setText("jButton5");
        getContentPane().add(jButton97);
        jButton97.setBounds(1880, 400, 73, 23);

        jButton98.setBackground(new java.awt.Color(0, 51, 51));
        jButton98.setText("jButton5");
        getContentPane().add(jButton98);
        jButton98.setBounds(1810, 440, 73, 23);
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        dbq.populateOnlyUnaddedAccounts(jTable1);
...
jTable1.setShowGrid(true);
        ...
        jTable1.getColumnModel().getColumn(hc).setMinWidth(0);
        jTable1.getColumnModel().getColumn(hc).setMaxWidth(1500);
        jTable1.getColumnModel().getColumn(hc).setPreferredWidth(400);
        }
        if(hc==2){
        jTable1.getColumnModel().getColumn(hc).setMinWidth(0);
        jTable1.getColumnModel().getColumn(hc).setMaxWidth(1500);
        jTable1.getColumnModel().getColumn(hc).setPreferredWidth(180);
        }if(hc==3){
        ...
        jTable1.getColumnModel().getColumn(hc).setMinWidth(4);
        jTable1.getColumnModel().getColumn(hc).setMaxWidth(1500);
        jTable1.getColumnModel().getColumn(hc).setPreferredWidth(130);
        }
...
if(col==4){
  ...
  wasNot.updateTheFields(itemIndicator);
 this.dispose();
    ...
    public void mousePressed(MouseEvent me) {
		   ...
		   if (selectedRow > -1&&selectedColumn>-1)
	   {
         ...
         Object cvalue = jTable1.getModel().getValueAt( jTable1.convertRowIndexToModel(selectedRow), 2);
            if(!dbq.accountExists(cvalue.toString(),accountDetails.this))  {
   itemIndicator = cvalue.toString();
    
             jButton2.setEnabled(true);
           jButton3.setEnabled(true);
            }else{
      JOptionPane.showMessageDialog(this, "The account already exists");
             jButton2.setEnabled(false);
           jButton3.setEnabled(false);
