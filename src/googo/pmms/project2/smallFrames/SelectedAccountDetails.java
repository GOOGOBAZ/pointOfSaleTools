 ...
 */
public class SelectedAccountDetails extends javax.swing.JFrame implements MouseListener, IUpdateText, ActionListener{
        ...
        public SelectedAccountDetails(String userId,String destinationView,String accountNumber) { 
        initComponents();
        this.userId=userId;
    ...
    private void initComponents() {
        ...
        jTextField1.setBounds(290, 350, 330, 40);

        jLabel1.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel1.setText("SEARCH HERE");
        jLabel1.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        jPanel1.add(jLabel1);
        jLabel1.setBounds(120, 350, 150, 40);
 ...
 switch(dfestinationView){
     ...
     case "LStatmentView":
         dbq.fillMeWithLoanStatementIn(jTable1,this);
...
TableRowSorter<TableModel> rowSorter  = new TableRowSorter<>(table.getModel());
    ...
    String accountNumber = jTable1.getModel().getValueAt( jTable1.convertRowIndexToModel(selectedRow), 2).toString();
    String accountName=jTable1.getModel().getValueAt( jTable1.convertRowIndexToModel(selectedRow), 1).toString();
   
     switch(dfestinationView){
 
     case "LStatmentView":
         newWindowPrintOr("LStatmentViewDetails",accountNumber,accountName);
         break;
...
//         break;
          ...
          case "FOrPrintintTheReceipt":
         newWindowPrintOr("FOrPrintintTheReceipt",accountNumber,accountName);
         break;
    ...
    private void newWindowPrintOr(String typeS,String accountNumber,String accountName){
    
         SelectedAccountDetailsDetails theNames=new SelectedAccountDetailsDetails(this.userId,typeS,accountNumber);

      fios.stringFileWriter(fios.createFileName("loanApplication", "amortValues", "stateName"+this.userId+".txt"), accountName);
