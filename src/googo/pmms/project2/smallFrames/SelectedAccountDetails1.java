 ...
 */
public class SelectedAccountDetails1 extends javax.swing.JFrame implements MouseListener, IUpdateText, ActionListener{
        String userId,dfestinationView,theAccount,loanId;
        ...
        GaurantorsDetails component;
        public SelectedAccountDetails1(String userId,String destinationView,String accountNumber,GaurantorsDetails comp) { 
        initComponents();
          component=comp;
        this.userId=userId;
...
TableRowSorter<TableModel> rowSorter  = new TableRowSorter<>(table.getModel());
   ...
   this.component.setTheLoanId(loanId);
   this.component.jButton6.setText(loanId);
//   JOptionPane.showMessageDialog(this, loanId);
this.dispose();
           }}
