...
this.userId=userid;
   ...
   public boolean createPAndL(String startDate,String endDate,String fileName,Component c) { 
...
createActuallyPandL(startDate,endDate,fileName,c);
PAndL=true;
  } 
...
PAndL=true;
      ...
      private void createActuallyPandL(String startDate,String endDate,String fileName,Component c){
      try {
          ...
          PdfWriter writer=PdfWriter.getInstance(document, fios.FileOutputStream(fios.createFileName("PMMS_Statements", "PMMS_Statements1", fileName+".pdf")));
            body = createTodayPAndL(startDate,endDate,c);
...
//    cell3.setBorderWidth (2f);
  ...
  return table;
      ...
      public  PdfPTable createTodayPAndL(String startDate,String endDate,Component c){
