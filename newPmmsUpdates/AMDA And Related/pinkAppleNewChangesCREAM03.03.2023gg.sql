...
DELIMITER $$
CREATE PROCEDURE agingAnalysis() READS SQL DATA 
   BEGIN
...
DELIMITER $$
CREATE PROCEDURE agingAnalysisStaff(IN staffId INT) READS SQL DATA 
   BEGIN
...
-- 95	TULINAWE CALEB 0709554578	05502006410
...
-- -- CALL RepayTheLoanNow('05502006410',50000.0,'BTN34249',10001,'2023-02-21',10001);

-- -- CALL createNewLoan('05502006410',400000,180,30,'2023-02-14',1,'DAYS',10001,1.0,'2023-02-14',10001,0,1,'BTN34249',1) ;
