...
DECLARE forselectingLoanId CURSOR FOR SELECT trn_id,loan_id  FROM elite_loans.new_loan_appstore;
...
DROP PREPARE stmt9;
  ...
  SET @sql_text7 = concat(CAST('INSERT INTO  elite_loans.new_loan_appstoreamort( 
  instalment_no,
  princimpal_amount ,
  princimpal_amount_run_bal ,
  interest_amount ,
  ...
  OtherThree,
  master1_id,
  master2_id FROM elite_loans.tempT ' AS CHAR CHARACTER SET utf8));
...
CREATE PROCEDURE OpeningCashBalance(IN theDate DATE,OUT OpeningCahdBala VARCHAR(100)) READS SQL DATA BEGIN
 ...
 DECLARE forSelectingCashAccounts CURSOR FOR SELECT account_number  FROM elite.account_created_store WHERE account_number LIKE '01123%'; /* cursor for iterating through each borrower's account*/
...
LEAVE accounts_loop;
 ...
 END IF;
   ...
   SET @sql_text = concat(CAST(" SELECT  ledger_balance INTO @openBalance FROM    elite.bsanca" AS CHAR CHARACTER SET utf8),cashAccountRep,CAST(" WHERE  trn_date<'" AS CHAR CHARACTER SET utf8),theDate,CAST("'  ORDER BY trn_id DESC LIMIT 1" AS CHAR CHARACTER SET utf8));
...
BEGIN
SELECT  SUM(credit) INTO processingFees FROM elite.general_ledger WHERE  trn_date=theDate AND debit_account_no LIKE '03315%';
...
-- DECLARE cursor_forSelectingProcessingFeesAccounts CURSOR FOR SELECT account_number  FROM elite.account_created_store WHERE account_number LIKE '03315%';
...
-- SET @qr=CONCAT(CAST("CREATE TEMPORARY TABLE account_view AS SELECT chq_number FROM  elite.bsanca" AS CHAR CHARACTER SET utf8),processindFeesAccountRep,CAST("  WHERE trn_date='" AS CHAR CHARACTER SET utf8),theDate,CAST("'  AND other_one='Cr'" AS CHAR CHARACTER SET utf8));
...
-- SET @quary=CONCAT(CAST("SELECT credit INTO @amount FROM elite.bsanca" AS CHAR CHARACTER SET utf8),processindFeesAccountRep,CAST("  WHERE chq_number='" AS CHAR CHARACTER SET utf8),batchNumbersReps,CAST("'" AS CHAR CHARACTER SET utf8));
...
BEGIN
SELECT  SUM(credit) INTO ledgerFessCol FROM elite.general_ledger WHERE  trn_date=theDate AND debit_account_no LIKE '03304%';
...
-- DECLARE processindFeesAccountRep VARCHAR(30); 
-- DECLARE outer_done INTEGER DEFAULT 0; 
-- DECLARE cursor_forSelectingProcessingFeesAccounts CURSOR FOR SELECT account_number  FROM elite.account_created_store WHERE account_number LIKE '03304%';
-- DECLARE CONTINUE HANDLER FOR NOT FOUND SET outer_done=1;
...
BEGIN
SELECT  SUM(credit) INTO badDebtsRecover FROM elite.general_ledger WHERE  trn_date=theDate AND debit_account_no LIKE '03318%';
...
-- DECLARE processindFeesAccountRep VARCHAR(30); 
-- DECLARE outer_done INTEGER DEFAULT 0; 
-- DECLARE cursor_forSelectingProcessingFeesAccounts CURSOR FOR SELECT account_number  FROM elite.account_created_store WHERE account_number LIKE '03318%';
-- DECLARE CONTINUE HANDLER FOR NOT FOUND SET outer_done=1;
...
BEGIN
SELECT  SUM(credit) INTO memberShipFessCol FROM elite.general_ledger WHERE  trn_date=theDate AND debit_account_no LIKE '03309%';
...
-- DECLARE processindFeesAccountRep VARCHAR(30); 
-- DECLARE outer_done INTEGER DEFAULT 0; 
-- DECLARE cursor_forSelectingProcessingFeesAccounts CURSOR FOR SELECT account_number  FROM elite.account_created_store WHERE account_number LIKE '03309%';
-- DECLARE CONTINUE HANDLER FOR NOT FOUND SET outer_done=1;
...
BEGIN
SELECT  SUM(credit) INTO annualFeesRecovered FROM elite.general_ledger WHERE  trn_date=theDate AND debit_account_no LIKE '03316%';
...
-- DECLARE processindFeesAccountRep VARCHAR(30); 
-- DECLARE outer_done INTEGER DEFAULT 0; 
-- DECLARE cursor_forSelectingProcessingFeesAccounts CURSOR FOR SELECT account_number  FROM elite.account_created_store WHERE account_number LIKE '03316%'; 
-- DECLARE CONTINUE HANDLER FOR NOT FOUND SET outer_done=1;
...
BEGIN
SELECT  SUM(credit) INTO InterestR FROM elite.general_ledger WHERE  trn_date=theDate AND debit_account_no LIKE '03301%';
...
-- DECLARE processindFeesAccountRep VARCHAR(30); 
-- DECLARE outer_done INTEGER DEFAULT 0; 
-- DECLARE cursor_forSelectingProcessingFeesAccounts CURSOR FOR SELECT account_number  FROM elite.account_created_store WHERE account_number LIKE '03301%'; 
-- DECLARE CONTINUE HANDLER FOR NOT FOUND SET outer_done=1;
...
BEGIN
SELECT  SUM(credit) INTO accumulatedInterestR FROM elite.general_ledger WHERE  trn_date=theDate AND debit_account_no LIKE '03311%';
...
-- DECLARE processindFeesAccountRep VARCHAR(30); 
-- DECLARE outer_done INTEGER DEFAULT 0; 
-- DECLARE cursor_forSelectingProcessingFeesAccounts CURSOR FOR SELECT account_number  FROM elite.account_created_store WHERE account_number LIKE '03311%'; 
-- DECLARE CONTINUE HANDLER FOR NOT FOUND SET outer_done=1;
...
BEGIN
SELECT  SUM(credit) INTO loanPenaltyRecovered FROM elite.general_ledger WHERE  trn_date=theDate AND debit_account_no LIKE '03312%';
...
-- DECLARE processindFeesAccountRep VARCHAR(30); 
-- DECLARE outer_done INTEGER DEFAULT 0; 
-- DECLARE cursor_forSelectingProcessingFeesAccounts CURSOR FOR SELECT account_number  FROM elite.account_created_store WHERE account_number LIKE '03312%'; 
-- DECLARE CONTINUE HANDLER FOR NOT FOUND SET outer_done=1;
...
BEGIN
SELECT  SUM(credit) INTO otherIncomesCollectedX FROM elite.general_ledger WHERE  trn_date=theDate AND (debit_account_no like '03305%' OR debit_account_no like  '03306%' OR debit_account_no like  '03307%' OR debit_account_no like '03308%'  OR debit_account_no like  '03310%'  OR debit_account_no like  '03313%' OR debit_account_no like '03314%'  OR debit_account_no like '03317%' OR debit_account_no like  '03319%' OR debit_account_no like '03320%' OR debit_account_no like  '03321%' OR debit_account_no like  '03322%' OR debit_account_no like '03323%' OR debit_account_no like  '03324%' OR debit_account_no like  '03325%');
...
BEGIN
SELECT  SUM(credit) INTO payableCreatedFinal FROM elite.general_ledger WHERE  trn_date=theDate AND debit_account_no LIKE '05500%';
...
-- DECLARE processindFeesAccountRep VARCHAR(30); 
-- DECLARE outer_done INTEGER DEFAULT 0; 
-- DECLARE cursor_forSelectingProcessingFeesAccounts CURSOR FOR SELECT account_number  FROM elite.account_created_store WHERE account_number like '05500%';
-- DECLARE CONTINUE HANDLER FOR NOT FOUND SET outer_done=1;
...
-- SET @qr=CONCAT(CAST("CREATE TEMPORARY TABLE account_view AS SELECT trn_id FROM  elite.bsanca" AS CHAR CHARACTER SET utf8),processindFeesAccountRep,CAST("  WHERE trn_date='" AS CHAR CHARACTER SET utf8),theDate,CAST("'" AS CHAR CHARACTER SET utf8));
-- /* SELECT @qr; */
-- PREPARE stmt FROM @qr;
-- EXECUTE stmt;
-- DROP PREPARE stmt;
...
--  SET @quary=CONCAT(CAST("SELECT chq_number INTO @batch FROM elite.bsanca" AS CHAR CHARACTER SET utf8),processindFeesAccountRep,CAST("  WHERE trn_id='" AS CHAR CHARACTER SET utf8),batchNumbersReps,CAST("'" AS CHAR CHARACTER SET utf8));
...
-- SET @quary=CONCAT(CAST("SELECT credit INTO @amountCredit FROM elite.bsanca" AS CHAR CHARACTER SET utf8),processindFeesAccountRep,CAST("  WHERE trn_id='" AS CHAR CHARACTER SET utf8),batchNumbersReps,CAST("'" AS CHAR CHARACTER SET utf8));
...
-- SET @quary=CONCAT(CAST("SELECT debit INTO @amountDebit FROM elite.bsanca" AS CHAR CHARACTER SET utf8),processindFeesAccountRep,CAST("  WHERE trn_id='" AS CHAR CHARACTER SET utf8),batchNumbersReps,CAST("'" AS CHAR CHARACTER SET utf8));
-- PREPARE stm FROM @quary;
-- EXECUTE stm;
-- DEALLOCATE PREPARE stm;
...
BEGIN
SELECT  SUM(credit) INTO insurancePayableMadev FROM elite.general_ledger WHERE  trn_date=theDate AND debit_account_no LIKE '05524%';
...
--  DECLARE forSelectingInsurancePayableCreatedAccounts CURSOR FOR SELECT account_number  FROM elite.account_created_store WHERE  account_number like '05524%' ;
...
--    SET @sql_text = concat(CAST(" SELECT  ledger_balance INTO @openBalance FROM    elite.bsanca" AS CHAR CHARACTER SET utf8),insurancePayableAccountRep,CAST(" WHERE  trn_date<'" AS CHAR CHARACTER SET utf8),theDate,CAST("'  ORDER BY trn_id DESC LIMIT 1" AS CHAR CHARACTER SET utf8));
-- PREPARE stmt FROM @sql_text;
-- /* SELECT @sql_text; */
--   EXECUTE stmt;
-- DROP PREPARE stmt;

--  SET @sql_text = concat(CAST(" SELECT  ledger_balance INTO @closingBalance FROM    elite.bsanca" AS CHAR CHARACTER SET utf8),insurancePayableAccountRep,CAST(" WHERE  trn_date<='" AS CHAR CHARACTER SET utf8),theDate,CAST("'  ORDER BY trn_id DESC LIMIT 1" AS CHAR CHARACTER SET utf8));
-- PREPARE stmt FROM @sql_text;
-- /* SELECT @sql_text; */
--   EXECUTE stmt;
-- DROP PREPARE stmt;
...
BEGIN
SELECT  SUM(credit) INTO liabilityProvi FROM elite.general_ledger WHERE  trn_date=theDate AND (debit_account_no like '05504%' 
...
-- DECLARE processindFeesAccountRep VARCHAR(30); 
-- DECLARE outer_done INTEGER DEFAULT 0; 
-- DECLARE cursor_forSelectingProcessingFeesAccounts CURSOR FOR SELECT account_number  FROM elite.account_created_store WHERE (account_number like '05504%' 
...
BEGIN
SELECT  SUM(credit) INTO someEquity FROM elite.general_ledger WHERE  trn_date=theDate AND debit_account_no LIKE '04400%';
...
-- DECLARE processindFeesAccountRep VARCHAR(30); 
-- DECLARE outer_done INTEGER DEFAULT 0; 
-- DECLARE cursor_forSelectingProcessingFeesAccounts CURSOR FOR SELECT account_number  FROM elite.account_created_store WHERE account_number like '04400%';
-- DECLARE CONTINUE HANDLER FOR NOT FOUND SET outer_done=1;
...
BEGIN
SELECT  SUM(credit) INTO otheCapsAndReserversMade FROM elite.general_ledger WHERE  trn_date=theDate AND debit_account_no>='044010000110' AND debit_account_no<='04430999999';
...
-- DECLARE processindFeesAccountRep VARCHAR(30); 
-- DECLARE outer_done INTEGER DEFAULT 0; 
-- DECLARE cursor_forSelectingProcessingFeesAccounts CURSOR FOR SELECT account_number  FROM elite.account_created_store WHERE account_number>='044010000110' AND account_number<='04430999999';
-- DECLARE CONTINUE HANDLER FOR NOT FOUND SET outer_done=1;
...
BEGIN
SELECT  SUM(credit) INTO Refundreceiavale FROM elite.general_ledger WHERE  trn_date=theDate AND debit_account_no LIKE '01131%';
...
-- DECLARE processindFeesAccountRep VARCHAR(30); 
-- DECLARE outer_done INTEGER DEFAULT 0; 
-- DECLARE cursor_forSelectingProcessingFeesAccounts CURSOR FOR SELECT account_number  FROM elite.account_created_store WHERE account_number LIKE '01131%';
-- DECLARE CONTINUE HANDLER FOR NOT FOUND SET outer_done=1;
...
BEGIN
SELECT  SUM(credit) INTO otherReceiAndPrepaymentRend FROM elite.general_ledger WHERE  trn_date=theDate AND debit_account_no LIKE '01118%';
...
-- DECLARE processindFeesAccountRep VARCHAR(30); 
-- DECLARE outer_done INTEGER DEFAULT 0; 
-- DECLARE cursor_forSelectingProcessingFeesAccounts CURSOR FOR SELECT account_number  FROM elite.account_created_store WHERE (account_number LIKE '01117%' OR account_number LIKE '01118%' OR account_number LIKE '01119%'
...
BEGIN
SELECT  SUM(credit) INTO BankWithdrws FROM elite.general_ledger WHERE  trn_date=theDate AND debit_account_no LIKE '01122%';
...
-- DECLARE processindFeesAccountRep VARCHAR(30); 
-- DECLARE outer_done INTEGER DEFAULT 0; 
-- DECLARE cursor_forSelectingProcessingFeesAccounts CURSOR FOR SELECT account_number  FROM elite.account_created_store WHERE account_number LIKE '01122%';
-- DECLARE CONTINUE HANDLER FOR NOT FOUND SET outer_done=1;
...
BEGIN
SELECT  SUM(credit) INTO princimpalRepaymentsMade FROM elite.general_ledger WHERE  trn_date=theDate AND debit_account_no LIKE '01128%';
...
-- DECLARE processindFeesAccountRep VARCHAR(30); 
-- DECLARE outer_done INTEGER DEFAULT 0; 
-- DECLARE cursor_forSelectingProcessingFeesAccounts CURSOR FOR SELECT account_number  FROM elite.account_created_store WHERE account_number LIKE '01128%';
-- DECLARE CONTINUE HANDLER FOR NOT FOUND SET outer_done=1;
...
BEGIN
SELECT  SUM(credit) INTO mobileMoneyRefund FROM elite.general_ledger WHERE  trn_date=theDate AND debit_account_no LIKE '01121%';
...
-- DECLARE processindFeesAccountRep VARCHAR(30); 
-- DECLARE outer_done INTEGER DEFAULT 0; 
-- DECLARE cursor_forSelectingProcessingFeesAccounts CURSOR FOR SELECT account_number  FROM elite.account_created_store WHERE account_number LIKE '01121%';
-- DECLARE CONTINUE HANDLER FOR NOT FOUND SET outer_done=1;
...
BEGIN
SELECT  SUM(credit) INTO fixedAssetsAndInvestmentDisp FROM elite.general_ledger WHERE  trn_date=theDate AND   (debit_account_no LIKE '01100%' OR debit_account_no LIKE '01101%'
...
-- DECLARE processindFeesAccountRep VARCHAR(30); 
-- DECLARE outer_done INTEGER DEFAULT 0; 
-- DECLARE cursor_forSelectingProcessingFeesAccounts CURSOR FOR SELECT account_number  FROM elite.account_created_store WHERE (account_number LIKE '01100%' OR account_number LIKE '01101%'
...
BEGIN
SELECT  SUM(debit) INTO ExpensesMa FROM elite.general_ledger WHERE  trn_date=theDate AND debit_account_no LIKE '022%';
...
-- DECLARE processindFeesAccountRep VARCHAR(30); 
-- DECLARE outer_done INTEGER DEFAULT 0; 
-- DECLARE cursor_forSelectingProcessingFeesAccounts CURSOR FOR SELECT account_number  FROM elite.account_created_store WHERE account_number LIKE '022%';
-- DECLARE CONTINUE HANDLER FOR NOT FOUND SET outer_done=1;
...
BEGIN
SELECT  SUM(debit) INTO interWriteOff FROM elite.general_ledger WHERE  trn_date=theDate AND debit_account_no LIKE '03301%';
...
BEGIN
SELECT  SUM(debit) INTO accumuIntereWrittenOff FROM elite.general_ledger WHERE  trn_date=theDate AND debit_account_no LIKE '03311%';
...
BEGIN
SELECT  SUM(debit) INTO processFeesWriteOff FROM elite.general_ledger WHERE  trn_date=theDate AND debit_account_no LIKE '03315%';
...
BEGIN
SELECT  SUM(debit) INTO otherIncomesWrOff FROM elite.general_ledger WHERE  trn_date=theDate AND (debit_account_no LIKE '03312%' OR debit_account_no LIKE '03316%' OR debit_account_no LIKE '03309%' OR debit_account_no LIKE '03318%' OR debit_account_no LIKE '03304%' OR debit_account_no like '03305%' OR debit_account_no like  '03306%' OR debit_account_no like  '03307%' OR debit_account_no like '03308%'  OR debit_account_no like  '03310%'  OR debit_account_no like  '03313%' OR debit_account_no like '03314%'  OR debit_account_no like '03317%' OR debit_account_no like  '03319%' OR debit_account_no like '03320%' OR debit_account_no like  '03321%' OR debit_account_no like  '03322%' OR debit_account_no like '03323%' OR debit_account_no like  '03324%' OR debit_account_no like  '03325%');
...
BEGIN
SELECT  SUM(debit) INTO receiavale FROM elite.general_ledger WHERE  trn_date=theDate AND debit_account_no LIKE '01131%';
...
BEGIN
SELECT  SUM(debit) INTO mobileMoneyc FROM elite.general_ledger WHERE  trn_date=theDate AND debit_account_no LIKE '01121%';
...
BEGIN
SELECT  SUM(debit) INTO otherRecePreMade FROM elite.general_ledger WHERE  trn_date=theDate AND  (debit_account_no LIKE '01117%' OR debit_account_no LIKE '01118%' OR debit_account_no LIKE '01119%'
...
BEGIN
SELECT  SUM(debit) INTO bankDepositMade FROM elite.general_ledger WHERE  trn_date=theDate AND debit_account_no LIKE '01122%';
...
BEGIN
SELECT  SUM(debit) INTO loansDisbursed FROM elite.general_ledger WHERE  trn_date=theDate AND debit_account_no ='01128000110';
...
BEGIN
SELECT  SUM(debit) INTO fixedAssetsAndInvestmentAquired FROM elite.general_ledger WHERE  trn_date=theDate AND  (debit_account_no LIKE '01100%' OR debit_account_no LIKE '01101%'
OR debit_account_no LIKE '01102%' OR debit_account_no LIKE '01103%' OR debit_account_no LIKE '01104%' OR debit_account_no LIKE '01105%' OR debit_account_no LIKE '01106%'  OR debit_account_no LIKE '01108%' OR debit_account_no LIKE '01109%'
OR debit_account_no LIKE '01110%' OR debit_account_no LIKE '01111%'  OR debit_account_no LIKE '01112%'  OR debit_account_no LIKE '01136%');
...
BEGIN
SELECT  SUM(debit) INTO RefundPayable FROM elite.general_ledger WHERE  trn_date=theDate AND debit_account_no LIKE '05500%';
...
BEGIN
SELECT  SUM(debit) INTO RefundPayableOtherLiabilProvis FROM elite.general_ledger WHERE  trn_date=theDate AND   (debit_account_no like '05504%' 
...
BEGIN
SELECT  SUM(debit) INTO insurancePayCleared FROM elite.general_ledger WHERE  trn_date=theDate AND debit_account_no LIKE '05524%';
...
-- DECLARE processindFeesAccountRep VARCHAR(30); 
-- DECLARE outer_done INTEGER DEFAULT 0; 
-- DECLARE cursor_forSelectingProcessingFeesAccounts CURSOR FOR SELECT account_number  FROM elite.account_created_store WHERE account_number like '05524%' ;
-- DECLARE CONTINUE HANDLER FOR NOT FOUND SET outer_done=1;
...
BEGIN
SELECT  SUM(debit) INTO DrawingM FROM elite.general_ledger WHERE  trn_date=theDate AND debit_account_no LIKE '04408%';
...
-- DECLARE processindFeesAccountRep VARCHAR(30); 
-- DECLARE outer_done INTEGER DEFAULT 0; 
-- DECLARE cursor_forSelectingProcessingFeesAccounts CURSOR FOR SELECT account_number  FROM elite.account_created_store WHERE account_number like '04408%' ;
-- DECLARE CONTINUE HANDLER FOR NOT FOUND SET outer_done=1;
...
BEGIN
SELECT  SUM(debit) INTO Decapitlise FROM elite.general_ledger WHERE  trn_date=theDate AND debit_account_no LIKE '04400%';
...
BEGIN
SELECT  SUM(debit) INTO equitiesReservesRemoved FROM elite.general_ledger WHERE  trn_date=theDate AND  ((debit_account_no>='044010000110' AND debit_account_no<='04430999999') AND NOT debit_account_no='04408000110');
...
-- DECLARE processindFeesAccountRep VARCHAR(30); 
-- DECLARE outer_done INTEGER DEFAULT 0; 
-- DECLARE cursor_forSelectingProcessingFeesAccounts CURSOR FOR SELECT account_number  FROM elite.account_created_store WHERE ((account_number>='044010000110' AND account_number<='04430999999') AND NOT account_number='04408000110');
-- DECLARE CONTINUE HANDLER FOR NOT FOUND SET outer_done=1;
...
SELECT COUNT(trn_id) INTO stat  from elite.general_ledger where chq_number=batchNumber AND debit_account_no LIKE '01123%';
...
SELECT COUNT(trn_id) INTO stat  from elite.general_ledger where chq_number=batchNumber AND credit_account_no LIKE '01123%';
IF stat IS NULL THEN
SET stat=0;
END IF;
END//
...
/* lastDate, */
 ...
 DECLARE forSelectingLoanIds CURSOR FOR SELECT loan_id  FROM elite_loans.new_loan_appstore WHERE loan_cycle_status='Disbursed';
...
CREATE PROCEDURE InterestManagementForLendersNonCompounded(IN loanIdZ VARCHAR(60)) READS SQL DATA BEGIN
 ...
 /* DECLARE forSelectingLoanIds CURSOR FOR SELECT loan_id  FROM elite_loans.new_loan_appstore WHERE loan_cycle_status='Disbursed'; cursor for iterating through each borrower's account */
...
SELECT TrnId,InterestBalance, LoanBalance INTO @idL, @intBal,@lBalance FROM elite.loandisburserepaystatement WHERE LoanId=loanId AND LoanStatusReport='Running' ORDER BY TrnId DESC LIMIT 1;
...
total_interest=@totalInterestAmount
 ...
 UPDATE elite.loandisburserepaystatement SET 
...
SELECT account_name INTO userNameNow FROM elite.log_in WHERE  user_id=userId ;
...
LEAVE accounts_loop;
 ...
 END IF;
SELECT pl.applicant_account_name,m.mobile1,pl.trn_date,pl.princimpal_amount,pl.TotalPrincipalRemaining,pl.TotalInterestRemaining,(pl.TotalPrincipalRemaining+pl.TotalInterestRemaining) INTO customerName, customerContactNumber,TrnDate,remainport,princeremain,interestRem,p_remain FROM elite.master m INNER JOIN elite_loans.new_loan_appstore pl ON pl.applicant_account_number=m.account_number WHERE  pl.loan_id=loanId;
...
SELECT account_name INTO staffNameNow FROM elite.log_in WHERE  user_id=staffId;
 IF ISNULL(staffNameNow) THEN
 SET staffNameNow='MISSING';
 END IF;
RETURN staffNameNow;
...
SELECT COUNT(TrnId) INTO activeCustomersSave FROM elite.newsavingsmembers WHERE TrnDate=DATE(NOW());
...
DECLARE forSelectingLoanIds CURSOR FOR SELECT loan_id  FROM elite_loans.new_loan_appstore WHERE loan_cycle_status='Disbursed' AND ( loan_tenure='1.0 MONTHS' OR loan_tenure= '1 MONTHS' ); /*  cursor for iterating through each borrower's account */
...
BEGIN
 ...
 SELECT instalment_due_date INTO InstalmentDueDate  FROM elite_loans.new_loan_appstoreamort WHERE instalment_no=InstalmentNo AND master2_id=loanId;


IF typOfRepayment='updateNewLoanPrincipalNow' THEN 


  SELECT ItemId,TotalNumberOfAllPrincipalLoanRepayments,TotalValueOfAllPrincipalLoanRepayments INTO ItemIdu,ExistingNumber,ExistingValue  FROM elite.summurystats ORDER BY ItemId DESC Limit 1;

  SET  ExistingNumber=ExistingNumber+1;
  SET  ExistingValue=ExistingValue+amountPAI;

UPDATE elite.summurystats SET TotalNumberOfAllPrincipalLoanRepayments=ExistingNumber,TotalValueOfAllPrincipalLoanRepayments=ExistingValue WHERE ItemId=ItemIdu;
  SET  ExistingNumber=0;
  SET  ExistingValue=0;

IF InstalmentDueDate=CURDATE() THEN 

  SELECT ItemId,TotalNumberOfPrincipalLoanRepaymentsDueLoansOnly,TotalValueOfPrincipalLoanRepaymentsDueLoansOnly INTO ItemIdu,ExistingNumber,ExistingValue  FROM elite.summurystats ORDER BY ItemId DESC Limit 1;

 SET ExistingNumber=ExistingNumber+1;
 SET ExistingValue=ExistingValue+amountPAI;

UPDATE elite.summurystats SET TotalNumberOfPrincipalLoanRepaymentsDueLoansOnly=ExistingNumber,TotalValueOfPrincipalLoanRepaymentsDueLoansOnly=ExistingValue WHERE ItemId=ItemIdu;
  SET  ExistingNumber=0;
  SET  ExistingValue=0;
...
IF InstalmentDueDate<CURDATE() THEN
 ...
 SELECT ItemId,TotalNumberOfArrearsPrincipalLoanRepayments,TotalValueOfArrearsPrincipalLoanRepayments INTO ItemIdu,ExistingNumber,ExistingValue  FROM elite.summurystats ORDER BY ItemId DESC Limit 1;

 SET ExistingNumber=ExistingNumber+1;
 SET ExistingValue=ExistingValue+amountPAI;

UPDATE elite.summurystats SET TotalNumberOfArrearsPrincipalLoanRepayments=ExistingNumber,TotalValueOfArrearsPrincipalLoanRepayments=ExistingValue WHERE ItemId=ItemIdu;
  SET  ExistingNumber=0;
 SET   ExistingValue=0;
END IF;
...
IF InstalmentDueDate>CURDATE() THEN 
  ...
  SELECT ItemId,TotalNumberOfEarlyPrincipalLoanRepayments,TotalValueOfEarlyPrincipalLoanRepayments INTO ItemIdu,ExistingNumber,ExistingValue  FROM elite.summurystats ORDER BY ItemId DESC Limit 1;

 SET ExistingNumber=ExistingNumber+1;
 SET ExistingValue=ExistingValue+amountPAI;

UPDATE elite.summurystats SET TotalNumberOfEarlyPrincipalLoanRepayments=ExistingNumber,TotalValueOfEarlyPrincipalLoanRepayments=ExistingValue WHERE ItemId=ItemIdu;
  SET  ExistingNumber=0;
  SET  ExistingValue=0;
END IF;
...
IF InstalmentDueDate>=CURDATE() THEN 
  ...
  SELECT ItemId,TotalNumberOfLoanRepaymentsMinusArrears,TotalValueOfLoanRepaymentsMinusArrears INTO ItemIdu,ExistingNumber,ExistingValue  FROM elite.summurystats ORDER BY ItemId DESC Limit 1;

 SET ExistingNumber=ExistingNumber+1;
 SET ExistingValue=ExistingValue+amountPAI;

UPDATE elite.summurystats SET TotalNumberOfLoanRepaymentsMinusArrears=ExistingNumber,TotalValueOfLoanRepaymentsMinusArrears=ExistingValue WHERE ItemId=ItemIdu;
  SET  ExistingNumber=0;
 SET   ExistingValue=0;
END IF;
...
IF typOfRepayment='updateNewInterestNow' THEN 
 ...
 SELECT ItemId,TotalNumberOfAllInterestPayments,TotalValueOfInterestReceived INTO ItemIdu,ExistingNumber,ExistingValue  FROM elite.summurystats ORDER BY ItemId DESC Limit 1;

  SET  ExistingNumber=ExistingNumber+1;
  SET  ExistingValue=ExistingValue+amountPAI;

UPDATE elite.summurystats SET TotalNumberOfAllInterestPayments=ExistingNumber,TotalValueOfInterestReceived=ExistingValue WHERE ItemId=ItemIdu;
  SET  ExistingNumber=0;
  SET  ExistingValue=0;
...
IF InstalmentDueDate=CURDATE() THEN 
 SELECT ItemId,TotalNumberOfInterestPaymentsDueLoansOnly,TotalValueOfInterestPaymentsDueLoansOnly INTO ItemIdu,ExistingNumber,ExistingValue  FROM elite.summurystats ORDER BY ItemId DESC Limit 1;

  SET  ExistingNumber=ExistingNumber+1;
  SET  ExistingValue=ExistingValue+amountPAI;

UPDATE elite.summurystats SET TotalNumberOfInterestPaymentsDueLoansOnly=ExistingNumber,TotalValueOfInterestPaymentsDueLoansOnly=ExistingValue WHERE ItemId=ItemIdu;
 SET   ExistingNumber=0;
  SET  ExistingValue=0;
...
IF InstalmentDueDate<CURDATE() THEN 
 ...
 SELECT ItemId,TotalNumberOfArrearsInterestPayments,TotalValueOfArrearsInterestPayments INTO ItemIdu,ExistingNumber,ExistingValue  FROM elite.summurystats ORDER BY ItemId DESC Limit 1;

  SET  ExistingNumber=ExistingNumber+1;
  SET  ExistingValue=ExistingValue+amountPAI;

UPDATE elite.summurystats SET TotalNumberOfArrearsInterestPayments=ExistingNumber,TotalValueOfArrearsInterestPayments=ExistingValue WHERE ItemId=ItemIdu;
  SET  ExistingNumber=0;
  SET  ExistingValue=0;
...
IF InstalmentDueDate>CURDATE() THEN 
 SELECT ItemId,TotalNumberOfEarlyInterestPayments,TotalValueOfEarlyInterestPayments INTO ItemIdu,ExistingNumber,ExistingValue  FROM elite.summurystats ORDER BY ItemId DESC Limit 1;

 SET   ExistingNumber=ExistingNumber+1;
  SET  ExistingValue=ExistingValue+amountPAI;

UPDATE elite.summurystats SET TotalNumberOfEarlyInterestPayments=ExistingNumber,TotalValueOfEarlyInterestPayments=ExistingValue WHERE ItemId=ItemIdu;
  SET  ExistingNumber=0;
  SET  ExistingValue=0;
...
SELECT ItemId,TotalNumberOfAllLoanPenaltyPayments,TotalValueOfAllLoanPenaltyPayments INTO ItemIdu,ExistingNumber,ExistingValue  FROM elite.summurystats ORDER BY ItemId DESC Limit 1;

  SET  ExistingNumber=ExistingNumber+1;
  SET  ExistingValue=ExistingValue+amountPAI;

UPDATE elite.summurystats SET TotalNumberOfAllLoanPenaltyPayments=ExistingNumber,TotalValueOfAllLoanPenaltyPayments=ExistingValue WHERE ItemId=ItemIdu;
  SET  ExistingNumber=0;
  SET  ExistingValue=0;
...
SELECT ItemId,TotalNumberOfAllAccumulatedInterestPayments,TotalValueOfAllAccumulatedInterestPayments INTO ItemIdu,ExistingNumber,ExistingValue  FROM elite.summurystats ORDER BY ItemId DESC Limit 1;

   SET ExistingNumber=ExistingNumber+1;
   SET ExistingValue=ExistingValue+amountPAI;

UPDATE elite.summurystats SET TotalNumberOfAllAccumulatedInterestPayments=ExistingNumber,TotalValueOfAllAccumulatedInterestPayments=ExistingValue WHERE ItemId=ItemIdu;
  SET  ExistingNumber=0;
  SET  ExistingValue=0;

END IF;

SELECT ItemId,TotalNumberOfAllInterestAndPrincipalLoanRepayments,TotalValueOfAllInterestAndPrincipalLoanRepayments INTO ItemIdu,ExistingNumber,ExistingValue  FROM elite.summurystats ORDER BY ItemId DESC Limit 1;

 SET ExistingNumber=ExistingNumber+1;
   SET ExistingValue=ExistingValue+amountPAI;

UPDATE elite.summurystats SET TotalNumberOfAllInterestAndPrincipalLoanRepayments=ExistingNumber,TotalValueOfAllInterestAndPrincipalLoanRepayments=ExistingValue WHERE ItemId=ItemIdu;
   SET ExistingNumber=0;
  SET  ExistingValue=0;
...
LEAVE accounts_loop;
 ...
 END IF;
SELECT pl.applicant_account_name,m.mobile1,pl.trn_date,pl.princimpal_amount,pl.TotalPrincipalRemaining,pl.TotalInterestRemaining,(pl.TotalPrincipalRemaining+pl.TotalInterestRemaining),pl.trn_id INTO customerName, customerContactNumber,TrnDate,remainport,princeremain,interestRem,p_remain,theTrnId FROM elite.master m INNER JOIN elite_loans.new_loan_appstore pl ON pl.applicant_account_number=m.account_number WHERE  pl.loan_id=loanId;
-- SELECT customerContactNumber,loanPort,paidport,remainport,prince,princepaid,princeremain;
...
-- DECLARE processindFeesAccountRep VARCHAR(30); 
-- DECLARE outer_done INTEGER DEFAULT 0; 
-- DECLARE cursor_forSelectingProcessingFeesAccounts CURSOR FOR SELECT account_number  FROM elite.account_created_store WHERE account_number like '05502%';
-- DECLARE CONTINUE HANDLER FOR NOT FOUND SET outer_done=1;
...
--  END IF;
 ...
 SELECT  sum(SavingsRemoved) INTO savingDepositWith from elite.newsavingsmembers where  TrnDate=DATE(NOW());
...
-- END IF;
 ...
 SELECT  sum(SavingsAdded) INTO savingsDepositC from elite.newsavingsmembers where  TrnDate=DATE(NOW());
