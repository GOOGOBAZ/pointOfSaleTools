        ...
        * @author SSRN
        */
        public class ListDataModel_111  extends AbstractTableModel {
        ...
        public ListDataModel_111(List<List<Object>>  d,  List <String>  c){
        ...
        lastRow.add(fmt.formatForStatementNumbers(totalValueColumn(6)+""));
