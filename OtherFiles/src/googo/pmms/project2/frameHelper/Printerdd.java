...
public class Printerdd implements Printable {
    ...
    public Printerdd(JTable table, JTable.PrintMode printMode, MessageFormat headerFormat, MessageFormat footerFormat) {
        ...
        headerFont = new java.awt.Font("Arial", 1, 18);
        footerFont = new java.awt.Font("Arial", 1, 13);
    }
    ...
    public int print(Graphics graphics, PageFormat pageFormat, int pageIndex) throws PrinterException {
        ...
        g2d.setColor(new java.awt.Color(102, 153, 255));
