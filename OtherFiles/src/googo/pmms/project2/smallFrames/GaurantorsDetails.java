 ...
 */
public class GaurantorsDetails extends javax.swing.JFrame implements MouseListener, IUpdateText, ActionListener,KeyListener{
String userId;
...
String GroupId,t1,t2,t3,t4,t5,t6;
   ...
   public GaurantorsDetails(String userId,String accountNumb) {
        ...
        this.setTitle("SET GAURANTORS"); 
//        initComponents();
    }
   
public void setTheLoanId(String theLoanIdX){

this.theLoanId=theLoanIdX;
    ...
    private void initComponents() {
        ...
        jButton4.setBounds(510, 410, 170, 50);

        jTextField15.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jPanel6.add(jTextField15);
        jTextField15.setBounds(330, 100, 580, 40);

        jLabel24.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel24.setText("GAURANTORS CONTACT2");
        jLabel24.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        jPanel6.add(jLabel24);
        jLabel24.setBounds(60, 140, 270, 40);

        jTextField17.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jTextField17.setText("N/A");
        jPanel6.add(jTextField17);
        jTextField17.setBounds(330, 140, 580, 40);

        jLabel25.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel25.setText("GAURANTORS ID NUMBER");
        jLabel25.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        jPanel6.add(jLabel25);
        jLabel25.setBounds(60, 180, 270, 40);

        jTextPane1.setText("N/A");
        jScrollPane1.setViewportView(jTextPane1);

        jPanel6.add(jScrollPane1);
        jScrollPane1.setBounds(330, 260, 580, 70);

        jTextField19.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jTextField19.setText("N/A");
        jPanel6.add(jTextField19);
        jTextField19.setBounds(330, 180, 580, 40);

        jLabel26.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel26.setText("GAURANTORS CONTACT1");
        jLabel26.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        jPanel6.add(jLabel26);
        jLabel26.setBounds(60, 100, 270, 40);

        jLabel27.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel27.setText("GAURANTORS NAME");
        ...
        jButton5.setBounds(330, 410, 170, 50);

        jButton6.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jButton6.setText("SELECT LOAN");
        ...
        jButton6.setBounds(290, 10, 360, 50);
        if(!this.theLoanId.equalsIgnoreCase("")){
            jButton6.setEnabled(false);
        }

        jLabel28.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel28.setText("RESIDENCE DESCRIPTION");
        jLabel28.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        jPanel6.add(jLabel28);
        jLabel28.setBounds(60, 260, 270, 40);

        jTextField20.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jTextField20.setText("N/A");
        jPanel6.add(jTextField20);
        jTextField20.setBounds(330, 220, 580, 40);

        jTextPane2.setText("N/A");
        jScrollPane2.setViewportView(jTextPane2);

        jPanel6.add(jScrollPane2);
        jScrollPane2.setBounds(330, 330, 580, 70);

        jLabel29.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel29.setText("BUSINESS DESCRIPTION");
        jLabel29.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        jPanel6.add(jLabel29);
        jLabel29.setBounds(60, 330, 270, 40);

        jLabel30.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel30.setText("RELATIONSHIPWITHBORROWER");
        jLabel30.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        jPanel6.add(jLabel30);
        jLabel30.setBounds(60, 220, 270, 40);

        jPanel1.add(jPanel6);
        jPanel6.setBounds(30, 20, 960, 510);
...
this.dispose();
//JOptionPane.showMessageDialog(this, theLoanId);
...
if(theLoanId.equalsIgnoreCase("")){

JOptionPane.showMessageDialog(this, "Please first select the laonID to set the Gaurantors");

}else{

    if(jTextField16.getText().equalsIgnoreCase("")){

JOptionPane.showMessageDialog(this, "Please first input Gaurantor's Name");

}else{

  if(jTextField15.getText().equalsIgnoreCase("")){

JOptionPane.showMessageDialog(this, "Please first input Gaurantor's Contact 1");

}else{

  if(jTextField17.getText().equalsIgnoreCase("")){

JOptionPane.showMessageDialog(this, "Please first input Gaurantor's Contact 2");

}else{

  if(jTextField19.getText().equalsIgnoreCase("")){

JOptionPane.showMessageDialog(this, "Please first input Gaurantor's Id Number");

}else{

 if(jTextField20.getText().equalsIgnoreCase("")){

JOptionPane.showMessageDialog(this, "Please first input Gaurantor's Relationship with borrower");

}else{

 if(jTextPane1.getText().equalsIgnoreCase("")){

JOptionPane.showMessageDialog(this, "Please first input Gaurantor's Residence description");

}else{


 if(jTextPane2.getText().equalsIgnoreCase("")){

JOptionPane.showMessageDialog(this, "Please first input Gaurantor's Business description");

}else{

     
      if(numberMatches(jTextField15.getText())){
         
           List theData= new ArrayList();

theData.add(jTextField16.getText());
theData.add(jTextField15.getText());
theData.add(jTextField17.getText());
theData.add(jTextField19.getText());
theData.add(jTextField20.getText());
theData.add(jTextPane1.getText());
theData.add(jTextPane2.getText());
theData.add(theLoanId);
dbq.createGaurantor(theData,this);
   JOptionPane.showMessageDialog(this, "Gaurantor details added successfully");
   this.dispose();
         }else{
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        SelectedAccountDetails1 theNames=new SelectedAccountDetails1(this.userId,"ForSetGaurantors",accountNumber,this);
