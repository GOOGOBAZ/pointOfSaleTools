...
-- SELECT amountRemain2,loanCycleStatus;
...
-- SELECT runningInstalmentId,"2";
-- SELECT runningInstalmentId,currentIntestX,theLoanId,instalmentPaidDate,"2X";
CALL updateTheInterestComponent(runningInstalmentId,currentIntestX,theLoanId,instalmentPaidDate);
...
IF currentAccumulatedInterestX>0 THEN
-- SELECT currentAccumulatedInterestX,amountTxed,"6";
IF currentAccumulatedInterestX>=amountTxed THEN
SET currentAccumulatedInterestX=amountTxed;
END IF;
...
-- SELECT balanceCdue,instalmentsCpaid,TotalInterestCPaid,TotalInterestCRemaining,TotalPrincipalCPaid,TotalPrincipalCRemaining,TotalAccumulatedInterestCPaid,TotalAccumulatedInterestCRemaining,TotalLoanPenaltyCPaid,TotalLoanPenaltyCRemaining,TotalAccruedInterestCRemaining,TotalAccruedInterestCPaid,"7";
